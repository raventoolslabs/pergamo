 ...
 * pueda decidir si la firma merece entrar en el local.ign2 de clamd. El fichero no
...
const release = async () => {
  ...
  log.info('If this signature keeps flagging legitimate documents, add it to local.ign2 in the clamd DatabaseDirectory and restart clamd.');
}
